        ...
        <script type="text/javascript">
            ...
            $(function () {
                $.ajax({
                    ...
                    data: {
                        idDeveloper: new URL(window.location.href).searchParams.get("idDeveloper").toString()
                    }
                    ,
                    success: function (data) {
                        ...
                        corpo = data;
                        corpo += "";
                        $('#idDeveloper').val(data.id);
                        $('#nome').val(data.nome);
                        $('#data_nascimento').val(data.dataNascimento);
                        $('#sexo').val(data.sexo);
                                            ...
                                            <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="span12" style="padding: 1%; margin-left: 0">
                                                    ...
                                                    <div class="span4">                                        
                                                        ...
                                                        <input id="idDeveloper" type="hidden"  name="idDeveloper" />
